export type QuestCategory = 'performance' | 'creative' | 'photo' | 'words' | 'chaos';
...
export const feedQuests: FeedQuest[] = [
  ...
  },
  {
    ...
    risk: 'wild',
    timeAgo: '16 хв',
    title: 'Зніми реакцію друга на комплімент: "ти виглядаєш як Wi-Fi з повним сигналом".',
  },
  {
    id: 'meme-frame',
    author: 'retro.nazar',
...
export const questOfDay: FeedQuest = {
  ...
  risk: 'spicy',
  timeAgo: 'сьогодні',
  title: 'Рандомний квест дня: сфоткай найепічнішу тінь у місті та дай їй назву.',
};
...
export const shorts: QuestShort[] = [
  {
    ...
    author: '@quest.master',
    comments: '342',
    description: 'Коли квест зайшов надто далеко, а ти вже не можеш зупинитись.',
    likes: '24.8K',
...
] satisfies { id: string; title: string; subtitle: string; quests: TrackerQuest[] }[];
...
export const walletTransactions = [
  { id: 't1', title: 'NPC голос у кавʼярні', amount: '+75 грн', status: 'Виплачено' },
  { id: 't2', title: 'Мем про доставку', amount: '+45 грн', status: 'Очікує автора' },
  { id: 't3', title: 'Поповнення балансу', amount: '-250 грн', status: 'Monobank draft' },
];
